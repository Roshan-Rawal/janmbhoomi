...
<div class="container">
<div class="row">
<h1 style="height:50px;color:#ffffff;text-align:center;background-color:#de4949;margin-right:150px;margin-left:150px;">User Login</h1>
</div>
<br>
<br>
<div class="row" style="margin-right:135px;margin-left:135px;">
<form action="userconnection.php" method="POST" enctype="multipart/form-data">
